<div class="page-content margin-fix">
    ...
    <p>
        ...
        connections between entities. We believe in a world of green technology and there is a vast of possibilities as well
        as specialities required to progress on this in future. So, why not innovate and improve the future together?
        The other reason is that running the HortusFox ecosystem requires substantial infrastructure and ongoing server maintenance. 
    ...
    <p>
        ...
        its development direction, or its community policies. Partners and affiliates do not receive special access or privileges 
    ...
    <p>
        <a class="button is-link button-stretched" href="mailto:{{ env('APP_CONTACT') }}">Contact</a>
    </p>
</div>